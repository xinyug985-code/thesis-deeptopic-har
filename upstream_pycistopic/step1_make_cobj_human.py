...
MANIFEST = RUNS / "fragments_manifest_human.tsv"
META_TSV = BASE / "metadata_pycistopic.tsv"
PEAKS_BED = BASE / "consensus_peaks_human_3col.bed"

OUT_PKL = OUTDIR / "1_cobj_human.pkl"
REPORT_TSV = OUTDIR / "step1_validbc_report_human.tsv"
META_FILTERED_OUT = OUTDIR / "metadata.human.filtered_noUnknown.tsv"

PROJECT = "xinyu_topicpipe_human"
...
print("\nStep1 human full completed successfully.")
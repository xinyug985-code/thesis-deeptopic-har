...
#SBATCH --mem=440G
#SBATCH -J cobj_human
#SBATCH -o /cfs/klemming/projects/supr/snic2022-23-547/xinyu/runs/logs/step1_human_%j.out
#SBATCH -e /cfs/klemming/projects/supr/snic2022-23-547/xinyu/runs/logs/step1_human_%j.err
...
python runs/step1_make_cobj_human.py
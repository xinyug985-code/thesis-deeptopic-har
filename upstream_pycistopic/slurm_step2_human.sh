...
#SBATCH --mem=440G
#SBATCH -J lda_human
#SBATCH -o /cfs/klemming/projects/supr/snic2022-23-547/xinyu/runs/logs/step2_human_%j.out
#SBATCH -e /cfs/klemming/projects/supr/snic2022-23-547/xinyu/runs/logs/step2_human_%j.err
...
python runs/step2_run_lda_human.py
...
# paths: model / labels
# =========================
MODEL_PATH = Path("/mimer/NOBACKUP/groups/naiss2025-22-612/xinyu/pjt/runs/out/deeptopic_human/final_model.keras")
ADATA_PATH = Path("/mimer/NOBACKUP/groups/naiss2025-22-612/xinyu/pjt/runs/out/human_topics.h5ad")
OUT_DIR = Path("/mimer/NOBACKUP/groups/naiss2025-22-612/xinyu/pjt/runs/out/har_3species_hscores")
...
def main():
    ...
    human_out = score_one_bed(
        ...
        species_label="human",
        out_csv=OUT_DIR / "human_activeHAR_scores_humanModel.csv",
    )
    ...
    chimp_out = score_one_bed(
        ...
        class_names=class_names,
        species_label="chimp",
        out_csv=OUT_DIR / "chimp_activeHAR_scores_humanModel.csv",
    )
    ...
    macaque_out = score_one_bed(
        ...
        out_csv=OUT_DIR / "macaque_activeHAR_scores_humanModel.csv",
    )

    # merge all
    all_out = pd.concat([human_out, chimp_out, macaque_out], axis=0, ignore_index=True)
    all_csv = OUT_DIR / "all_3species_activeHAR_scores_humanModel.csv"

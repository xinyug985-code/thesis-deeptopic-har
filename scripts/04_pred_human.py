...
MODEL_PATH = OUTD / "deeptopic_human" / "final_model.keras"

SAVE_DIR = OUTD / "deeptopic_human" / "prediction_inspection"
...
OUT_H5AD = SAVE_DIR / "human_topics_with_predictions.h5ad"
...
def main():
    ...
    adata.layers["pred_human"] = predictions.T  # (n_obs, n_vars)
